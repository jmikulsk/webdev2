...
//     }
    ...
    //     element.style.border = '5px solid blue';
    // }
    // document.getElementById('special').parentNode.style.border = '5px solid pink';
    ...
    // document.getElementById('container').firstElementChild.style.border = '5px solid green';
    document.getElementById('container').lastElementChild.style.border = '5px solid green';
}